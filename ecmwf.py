...
if __name__ == "__main__":
    date = pd.date_range(start='2019-12-01', end='2019-12-01')
    ...
    for p in p_levels:
        ...
        fig.savefig(basefolder+'ECMWF_overview_polar_'+str(date.year)+str(date.month)+str(date.day)+'_'+str(p)+'hPa'+'.pdf', dpi=500)
